...
The script script_train_model_improved.py has extra functionality.
 ...
 - AND BEST it loads data per batch
    - this allows you to train very big datasets as long as training and validation batches fit in memory
...
Next could be
 ...
 - use a black line to draw a basic shape (rectangle, triangle,.. ) and add shape for third set of output neurons
    ...
    - use more layers in your model to get better results
