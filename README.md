...
'my_venv/bin/pip show ai_edge_litert' showed version 1.3.0 on a June 2025 installation and 1.4.0 on a July 2025 inatallation.
...
Later installations also gave warnings for scikit-learn 1.7.1 and I changed that to an earlier version 1.7.0 the same way.
